...
import paddle.R;
import paddle.blockm.adapters.BlockedCallAdapter;
...
public class BlockedCallsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new BlockedCallAdapter(this.getContext());
    ...
    private void updateCalls() {
        adapter.clear();
        adapter.update(BlockLog.listAll(BlockLog.class));
